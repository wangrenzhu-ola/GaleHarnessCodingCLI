---
name: report-bug-gh
description: Report a bug in GaleHarnessCLI
argument-hint: "[optional: brief description of the bug]"
disable-model-invocation: true
---

# Report a GaleHarnessCLI Bug

Report bugs encountered while using GaleHarnessCLI. This skill gathers structured information and creates a GitHub issue.
...
---
*Reported via `/report-bug-gh` skill*
```
...
```bash
gh issue create \
  --repo wangrenzhu-ola/GaleHarnessCLI \
  --title "[GaleHarnessCLI] Bug: [Brief description]" \
...
3. Let them know the maintainer (wangrenzhu) will be notified
...
Issue: https://github.com/wangrenzhu-ola/GaleHarnessCLI/issues/[NUMBER]
Title: [GaleHarnessCLI] Bug: [description]
