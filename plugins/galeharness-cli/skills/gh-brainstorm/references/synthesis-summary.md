...
If the user response indicates they're in the wrong skill or want a different workflow (e.g., "this is too small, just /gh:work it" or "this needs more thought, let me brainstorm differently"):

- Stop gh-brainstorm
- Suggest the alternative skill the user appears to want (e.g., `/gh:work`, `/gh:debug`)
