...
- Post-mortem evidengh: core dumps, heap snapshots, captured state from after the failure, without observing during
...
- Disk spagh: `df -h` — out-of-space errors sometimes surface as cryptic write failures elsewhere
