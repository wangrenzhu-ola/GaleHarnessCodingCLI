...
- **Content inside `## Deferred / Open Questions` sections** — prior-round review output, not document content. This is the document-review workflow's own staging area
