...
- the gh-brainstorm skill - Explore requirements and approaches before planning
- the gh-plan skill - Create implementation plans
- the gh-review skill - Run comprehensive code reviews
- the gh-work skill - Execute work items systematically
- the gh-compound skill - Document solved problems
...
- [ ] Use slash syntax only when referring to an actual published command or workflow such as the gh-work skill or the gh-compound skill.
