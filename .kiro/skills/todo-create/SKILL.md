...
| Trigger | Flow |
|---------|------|
| Code review | the gh-review skill -> Findings -> the todo-triage skill -> Todos |
| Autonomous review | the gh-review skill mode:autofix` -> Residual todos -> the todo-resolve skill |
