...
1. **Code Review (`/gh:review`)**: If NOT already on the target branch (PR branch or requested branch), offer worktree for isolated review
2. **Feature Work (`/gh:work`)**: Always ask if user wants parallel worktree or live branch work
...
The skill is automatically called from the gh-review skill and the gh-work skill commands:
