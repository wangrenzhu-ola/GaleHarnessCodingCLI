...
```
POST the cards skill/:id/close    → POST the cards skill/:id/closure
DELETE the cards skill/:id/close  → DELETE the cards skill/:id/closure
POST the cards skill/:id/archive  → POST the cards skill/:id/archival
```
